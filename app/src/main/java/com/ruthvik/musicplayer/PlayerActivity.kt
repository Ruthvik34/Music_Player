...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(
        ...
        if (
            ...
            PlaybackManager.updatePlaylistKeepingPlayback(
                songList
            )
        }
    ...
    private fun setUpSeekBar() {
        ...
        binding.seekBar.addOnSliderTouchListener(
            object : Slider.OnSliderTouchListener {
                ...
                override fun onStopTrackingTouch(
                    ...
                    PlaybackManager.seekToProgress(
                        slider.value
                    )
    ...
    private fun setUpGestureDetectors() {
        ...
        gestureDetectorLeft.setOnDoubleTapListener(
            object :
        ...
        gestureDetectorRight.setOnDoubleTapListener(
            object :
                GestureDetector.OnDoubleTapListener {
        ...
        binding.doubleTapLeft.setOnTouchListener {
                _,
                event ->

            gestureDetectorLeft.onTouchEvent(
                event
            )
        }

        binding.doubleTapRight.setOnTouchListener {
                _,
                event ->

            gestureDetectorRight.onTouchEvent(
                event
            )
        }
    }
    ...
    private fun updateToggleAlpha() {
        ...
        val shuffleOn =
            PlaybackManager.isShuffle ||
                    (
                            exoPlayer?.shuffleModeEnabled
                                    == true
                            )

        binding.ivShuffle.alpha =
            if (shuffleOn) {
                1f
            } else {
                0.45f
        ...
        binding.ivRepeatOne.alpha =
            if (PlaybackManager.isRepeat) {
                1f
            } else {
                0.45f
            }
    ...
    private fun showDefaultAlbumArt() {
        ...
        binding.ivMusicImage.setImageResource(
            R.drawable.album_art_placeholder
        )

        binding.bgAlbumArt.setImageResource(
            R.color.background_dark
        )
    }

    private fun albumArtListener() =

...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Read local songs from Android MediaStore
     * and convert them into the Music POJO.
     */
        ...
        binding.tvSubtitle.text =
            ...
            when {
                ...
                count == 0 ->
                    ...
                    getString(
                        R.string.library_subtitle_empty
                    )

                likedCount > 0 ->

                    getString(
                        R.string.library_subtitle_with_likes,
                        count,
                        likedCount
                    )
